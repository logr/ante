 ...
 *
 * Kotlin port of material-color-utilities java/hct/HctSolver.java
 * (github.com/material-foundation/material-color-utilities @ f05459ea2170f3be610f89a4ddeee8843c2deb61).
 * Modifications: translated to Kotlin, package renamed, `internal` visibility, solveToCam dropped
 * because Cam16 is not ported (see NOTICE.md). Algorithm and constants unchanged.
 */
...
internal object HctSolver {
    ...
    val SCALED_DISCOUNT_FROM_LINRGB: Array<DoubleArray> =
        arrayOf(
    ...
    val LINRGB_FROM_SCALED_DISCOUNT: Array<DoubleArray> =
        arrayOf(
    ...
    val CRITICAL_PLANES: DoubleArray =
        doubleArrayOf(
     ...
     *   cube, in linear RGB coordinates, if it exists. If this possible vertex lies outside of the
     *   cube, [-1.0, -1.0, -1.0] is returned.
     */
    ...
    fun solveToInt(hueDegrees: Double, chroma: Double, lstar: Double): Int {
        ...
        val hueRadians = sanitizedHue / 180 * Math.PI
